...
import sgdk.rescomp.resource.Palette64;
import sgdk.tool.FileUtil;

public class Palette64Processor implements Processor
{
	private static final String resId = "PALETTE_64_COLORS";
    ...
    public Resource execute(String[] fields) throws Exception
    {
        ...
        return new Palette64(id, fileIn);
    }

//	public static void main(String[] args) throws Exception
//	{
//		Palette64Processor p = new Palette64Processor();
//		String[] fields = {
