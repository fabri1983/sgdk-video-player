...
public class Palette32AllStripsProcessor implements Processor
{
    ...
    public Resource execute(String[] fields) throws Exception
    {
        if (fields.length < 6)
        {
            ...
            System.out.println("  toggleEvery2Pals   If TRUE then the palettes are grabbed changing locations. If FALSE then it grabs palettes at fixed position.");
        ...
        PalettesPositionEnum palsPosition = PalettesPositionEnum.from(fields[4]);

        // get toggleEvery2Pals value
        boolean toggleEvery2Pals = Boolean.parseBoolean(fields[5]);
...
//        Compiler.addResourceFile(fileIn);
        ...
        return new Palette32AllStrips(id, stripsInList, palsPosition, toggleEvery2Pals, compression);
    }
...
//		String[] fields = {
//			resId, "pal_frame_46", "C:\\MyProjects\\VSCode\\sgdk\\sgdk-video-player-main\\res\\rgb\\frame_47_0_RGB.png", 
//			"21", PalettesPositionEnum.PAL0PAL1.getValue(), "TRUE", "FAST"
//		};
//		p.execute(fields);
//	}
}
