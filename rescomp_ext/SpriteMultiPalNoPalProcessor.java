...
import sgdk.rescomp.resource.SpriteMultiPalNoPal;
...
public class SpriteMultiPalNoPalProcessor implements Processor
{
	private static final String resId = "SPRITE_MULTI_PAL_NO_PAL";
    ...
    public Resource execute(String[] fields) throws Exception
    {
        if (fields.length < 5)
        {
            ...
            System.out.println("NOTE: This version discard the creation of any palette resource, but it process the sprite as it were multi palette.");
        ...
        return new SpriteMultiPalNoPal(id, fileIn, wf, hf, compression, time, collision, opt, optLevel, showCut, optDuplicate, spriteBoundariesPals);
    }
}
