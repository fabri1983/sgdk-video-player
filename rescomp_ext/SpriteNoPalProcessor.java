...
import sgdk.rescomp.resource.SpriteNoPal;
...
public class SpriteNoPalProcessor implements Processor
{
	private static final String resId = "SPRITE_NO_PAL";
    ...
    public Resource execute(String[] fields) throws Exception
    {
        if (fields.length < 5)
        {
            ...
            System.out.println("NOTE: This version discard the creation of any palette resource, but it process the sprite normally.");
        ...
        return new SpriteNoPal(id, fileIn, wf, hf, compression, time, collision, opt, optLevel, showCut, optDuplicate);
    }
}
