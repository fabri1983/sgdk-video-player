...
{
    public static TilesetForSpriteMultiPal getTileset(String id, String imgFile, Compression compression, TileOptimization tileOpt, boolean addBlank, boolean temp,
    		TileOrdering order, boolean export) throws Exception
    {
        ...
        final TilesetForSpriteMultiPal result = new TilesetForSpriteMultiPal(id, image, w, h, 0, 0, w / 8, h / 8, tileOpt, compression, addBlank, temp, order);
	...
	public TilesetForSpriteMultiPal(String id, byte[] image8bpp, int imageWidth, int imageHeight, List<? extends Rectangle> sprites, Compression compression, 
			boolean temp)
    {
        super(id);
