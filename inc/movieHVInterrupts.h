...
#define TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_NTSC max(0, MOVIE_MIN_TILE_Y_POS_AVOID_DMA_FLICKER - ((28 - 22) / 2))
#define MOVIE_HINT_COLORS_SWAP_START_SCANLINE_NTSC (((28 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_NTSC -1) * 8 - 1 // Frame with 22 tiles height: 16-1=15
#define MOVIE_HINT_COLORS_SWAP_END_SCANLINE_NTSC (28 - ((28 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_NTSC) * 8 - 2*8 - 1 // Frame with 22 tiles height: 200-2*8-1=183
...
// Since we have a min Y tile position to start drawing we have to adjust with the ideal scenario calculation
#define TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_PAL max(0, MOVIE_MIN_TILE_Y_POS_AVOID_DMA_FLICKER - ((30 - 22) / 2))
#define MOVIE_HINT_COLORS_SWAP_START_SCANLINE_PAL (((30 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_PAL + 1) * 8 - 1 // Frame with 22 tiles height: 24-1=23
#define MOVIE_HINT_COLORS_SWAP_END_SCANLINE_PAL (30 - ((30 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_PAL) * 8 - 2*8 - 1 // Frame with 22 tiles height: 208-2*8-1=191
