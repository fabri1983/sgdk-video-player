...
#define MOVIE_HINT_COLORS_SWAP_START_SCANLINE_NTSC (((28 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_NTSC + 1) * 8 - 1 // Frame with 22 tiles height: 32-1=31
...
#define MOVIE_HINT_COLORS_SWAP_START_SCANLINE_PAL (((30 - 22) / 2) + TILES_HEIGHT_OFFSET_DUE_TO_MIN_TILE_Y_POS_PAL + 1) * 8 - 1 // Frame with 22 tiles height: 40-1=39
