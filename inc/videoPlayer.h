...
#define VIDEO_FRAME_MAX_TILESET_CHUNK_SIZE 272 // Got experimentally from rescomp output (biggest summation of numTile). If odd then use next even number.
...
#define VIDEO_FRAME_MAX_TILEMAP_NUM_CHUNK (MOVIE_FRAME_EXTENDED_WIDTH_IN_TILES * (MOVIE_FRAME_HEIGHT_IN_TILES/3))
#define VIDEO_FRAME_MAX_TILEMAP_NUM_CHUNK_LAST (MOVIE_FRAME_EXTENDED_WIDTH_IN_TILES * ((MOVIE_FRAME_HEIGHT_IN_TILES/3) + (MOVIE_FRAME_HEIGHT_IN_TILES % 3)))
